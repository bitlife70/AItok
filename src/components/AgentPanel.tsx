    ...
    <div className="agent-panel flex flex-col h-full">
      ...
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-semibold text-gray-900">{t('agent.title')}</h2>
          <button
        ...
        {currentAgentStep && (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
            <div className="flex items-center gap-2 mb-1">
              ...
              <div className="text-sm font-medium text-blue-900">{t('agent.currentStep')}</div>
            </div>
        ...
        {/* Tab Navigation */}
        <div className="grid grid-cols-5 bg-gray-100 rounded-lg p-1 text-xs">
          <button
      ...
      <div className="flex-1 overflow-y-auto p-4">
            ...
            {agentProcesses.length === 0 ? (
              ...
              <div className="space-y-3">
                {agentProcesses.slice().reverse().map((process) => (
                  <div key={process.id} className="bg-white border border-gray-200 rounded-lg p-3 shadow-sm">
                    ...
                    {process.details && (
                      <div className="text-xs text-gray-600 mb-2 bg-gray-50 rounded p-2">{process.details}</div>
                    )}
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 gap-4">
              <div className="bg-white border border-gray-200 rounded-lg p-4">
                <div className="text-sm font-medium text-gray-700 mb-2">Response Time</div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-4">
                <div className="text-sm font-medium text-gray-700 mb-2">Total Requests</div>
            ...
            {/* Status Distribution */}
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <div className="text-sm font-medium text-gray-700 mb-3">Process Status</div>
        ...
        {activeTab === 'tools' && (
          <div className="space-y-4">
            {/* Tools Usage */}
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <div className="text-sm font-medium text-gray-700 mb-3">Tool Usage</div>
              {(() => {
                ...
                if (toolUsage.size === 0) {
                  return (
                    <div className="text-center py-4">
                      <WrenchScrewdriverIcon className="w-6 h-6 mx-auto text-gray-300 mb-2" />
                      <p className="text-sm text-gray-500">No tools used yet</p>
                    </div>
                  );
                }
